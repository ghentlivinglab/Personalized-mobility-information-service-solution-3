 ...
 * @author Backend Team
 */
public class EventProcessingCircleDAOTest {
    ...
    public EventProcessingCircleDAOTest() {
    }
    ...
    public void getTimeTravels_shouldThrowException() {
        try {
            ...
            try {
                eventProcessingCircleDAO.getTimeTravels(1, new Time(12, 0, 0), "example", new Coordinate(12.32, 4.32));
    ...
    public void getMatchingPOIs_shouldThrowException() {
        try {
            ...
            boolean thrown = false;
            try {
                eventProcessingCircleDAO.getMatchingPOIs("example", new Coordinate(12.32, 4.32));
            } catch (DataAccessException ex) {
                thrown = true;
            }
            assertTrue(thrown);
