...
import vop.groep7.vop7backend.database.sql.EventProcessingEllipseDAO;
...
public class EventProcessingEllipseDAOIT {

    private EventProcessingEllipseDAO eventProcessingEllipseDAO;
    ...
    public EventProcessingEllipseDAOIT() {
    ...
    public void setUp() throws SQLException {
        eventProcessingEllipseDAO = new EventProcessingEllipseDAO(dataSource.getConnection());
        // setup database
    ...
    public void getTimeTravels_shouldReturnMap() throws DataAccessException {
        ...
        Map<Integer, Map<Integer, List<Integer>>> result = eventProcessingEllipseDAO.getTimeTravels(3, new Time(expectedEvent.getLastEditTime().getTime()), expectedEvent.getType().getType(), expectedEvent.getLocation().getCoordinates());
    ...
    public void getMatchingPOIs_shouldReturnMap() throws DataAccessException {
        ...
        Map<Integer, List<Integer>> result = eventProcessingEllipseDAO.getMatchingPOIs(expectedEvent.getType().getType(), expectedEvent.getLocation().getCoordinates());
