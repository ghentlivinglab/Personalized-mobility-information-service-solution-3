...
public class EventProcessingSquareDAOIT {
    ...
    public EventProcessingSquareDAOIT() {
    ...
    public void setUp() throws SQLException {
        eventProcessingSquareDAO = new EventProcessingSquareDAO(dataSource.getConnection());
        // setup database
    ...
    public void getTimeTravels_shouldReturnMap() throws DataAccessException {
        ...
        Map<Integer, Map<Integer, List<Integer>>> result = eventProcessingSquareDAO.getTimeTravels(3, new Time(expectedEvent.getLastEditTime().getTime()), expectedEvent.getType().getType(), expectedEvent.getLocation().getCoordinates());
    ...
    public void getMatchingPOIs_shouldReturnMap() throws DataAccessException {
        ...
        Map<Integer, List<Integer>> result = eventProcessingSquareDAO.getMatchingPOIs(expectedEvent.getType().getType(), expectedEvent.getLocation().getCoordinates());
